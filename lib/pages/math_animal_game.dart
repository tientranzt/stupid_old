                                ...
                                content: SingleChildScrollView(
                                  child: Column(
                                    children: <Widget>[
                                      ...
                                      ...Provider.of<AnimalGameProvider>(context).listZodiac.keys.map((zodiac) {
                                        return HowToPlayAnimalGame(
                                          path: zodiac,
                                          name: Provider.of<AnimalGameProvider>(context).listZodiac[zodiac]['name'],
                                          score: Provider.of<AnimalGameProvider>(context).listZodiac[zodiac]['score'],
                                        );
                                      }).toList()
                                    ],
                                  ),
